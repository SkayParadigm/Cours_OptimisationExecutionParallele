...
public final class Worker implements Runnable
{
    ...
    public void run()
    {
        ...
        while( true )
        {
        	...
        	final IJob pAction = threadPool.consume() ;
            ...
            if ( pAction != null )
            {
            	...
            	{
            		System.err.println( DateUtils.getCurrentDateFormattedForLog() + " ++ System >> Worker (" + Thread.currentThread().getId() + "#" + Thread.currentThread().hashCode() + ") fatal error occurred (" + e.getClass().getSimpleName() + ") on job (" + pAction.getClass().getSimpleName() + ") !" ) ;
            		e.printStackTrace();
            	}
